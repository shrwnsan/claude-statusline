...
For the complete optimization strategy, implementation decisions, and why we chose not to pursue certain optimizations, see the [TypeScript Performance Optimization Plan](../plans/prd-001-typescript-perf-optimization.md).